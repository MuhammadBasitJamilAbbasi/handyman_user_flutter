...
const APP_NAME = 'Handymen To Call ';
const APP_NAME_TAG_LINE = 'On-Demand Home Services App';
var defaultPrimaryColor = Color(0xFF5F60B9);

const DOMAIN_URL = 'https://handymentocall.com'; // Don't add slash at the end of the url
...
const PROVIDER_PACKAGE_NAME = 'com.bj.handymenoncall.provider';
...
Country defaultCountry() {
  return Country(
    ...
    e164Key: '91-IN-0',
    fullExampleWithPlusSign: '+119123456789',
  );
}
