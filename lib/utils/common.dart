...
import 'package:com.bj.handmentocall/component/html_widget.dart';
import 'package:com.bj.handmentocall/component/location_service_dialog.dart';
import 'package:com.bj.handmentocall/component/new_update_dialog.dart';
...
import 'package:com.bj.handmentocall/screens/auth/auth_user_services.dart';
...
Widget mobileNumberInfoWidget() {
  return RichTextWidget(
    list: [
      ...
      TextSpan(text: ' "1-", "236-" ', style: boldTextStyle(size: 12)),
      TextSpan(
        text: ' (${language.help})',
